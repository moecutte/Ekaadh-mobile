              ...
              child: ListView(
                ...
                children: [
                      ...
                      children: [
                        ClipRRect(
                          ...
                          child: SizedBox(
                            ...
                            child: order.eventCover != null
                                ? DesignNetworkImage(url: order.eventCover)
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(order.eventTitle ?? l10n.t('event'), style: const TextStyle(fontWeight: FontWeight.w900, fontSize: 14)),
                  ...
                  Padding(
                    ...
                    child: Text(l10n.t('your_tickets_upper'), style: const TextStyle(fontSize: 11, fontWeight: FontWeight.w800, color: EkaadhColors.soft, letterSpacing: 1)),
                  ),
                  ...order.tickets.map((t) {
                    return InkWell(
                      onTap: () {
                        ...
                        child: Column(
                          children: [
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Text(l10n.t('valid'), style: const TextStyle(color: EkaadhColors.brand, fontWeight: FontWeight.w800, fontSize: 11)),
                                  ),
                                ],
                              ),
                            ),
                            ...
                            Padding(
                              ...
                              child: Text(l10n.t('tap_full_ticket'), style: const TextStyle(color: EkaadhColors.soft, fontSize: 11)),
                            ),
                          ],
                        ),
                      ),
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: Text(l10n.t('view_my_tickets')),
                ),
              ),
            ),
          ],
